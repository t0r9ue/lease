...
public class BrowsingHistoryController {
    ...
    private Result<IPage<HistoryItemVo>> page(@RequestParam long current, @RequestParam long size) {
        IPage<HistoryItemVo> historyItemVoPage = new Page<>(current, size);
        IPage<HistoryItemVo> resultPage = browsingHistoryService.findBrowsingHistoryByPage(historyItemVoPage);
